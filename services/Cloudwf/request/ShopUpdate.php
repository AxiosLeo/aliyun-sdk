 ...
 * @method integer getShopTopType()
 * @method $this setShopType($ShopType)
 * @method integer getShopType()
 * @method $this setShopSubtype($ShopSubtype)
 * @method integer getShopSubtype()
 * @method $this setShopArea($ShopArea)
 * @method integer getShopArea()
 ...
 * @method integer getShopCloseWarn()
 */
final class ShopUpdate extends CloudwfCommon
{
    public $action = 'ShopUpdate';
}
