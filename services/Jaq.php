...
class Jaq extends ProductAbstract
{
    ...
    protected $endpoints = [
        ...
        "public"   => [
            "ap-northeast-1" => "jaq.ap-southeast-1.aliyuncs.com",
            "ap-south-1"     => "jaq.ap-southeast-1.aliyuncs.com",
            "ap-southeast-1" => "jaq.ap-southeast-1.aliyuncs.com",
            "ap-southeast-2" => "jaq.ap-southeast-1.aliyuncs.com",
            "ap-southeast-3" => "jaq.ap-southeast-1.aliyuncs.com",
            "ap-southeast-5" => "jaq.ap-southeast-1.aliyuncs.com",
            ...
            "eu-central-1"   => "jaq.ap-southeast-1.aliyuncs.com",
            "eu-west-1"      => "jaq.ap-southeast-1.aliyuncs.com",
            "me-east-1"      => "jaq.ap-southeast-1.aliyuncs.com",
            "us-east-1"      => "jaq.ap-southeast-1.aliyuncs.com",
