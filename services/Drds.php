...
class Drds extends ProductAbstract
{
    ...
    protected $endpoints = [
        ...
        "public"   => [
            "ap-northeast-1" => "drds.ap-northeast-1.aliyuncs.com",
            "ap-south-1"     => "drds.ap-northeast-1.aliyuncs.com",
            "ap-southeast-1" => "drds.ap-southeast-1.aliyuncs.com",
            "ap-southeast-2" => "drds.ap-northeast-1.aliyuncs.com",
            "ap-southeast-3" => "drds.ap-northeast-1.aliyuncs.com",
            "ap-southeast-5" => "drds.ap-northeast-1.aliyuncs.com",
            ...
            "eu-central-1"   => "drds.ap-northeast-1.aliyuncs.com",
            "eu-west-1"      => "drds.ap-northeast-1.aliyuncs.com",
            "me-east-1"      => "drds.ap-northeast-1.aliyuncs.com",
            "us-east-1"      => "drds.ap-northeast-1.aliyuncs.com",
            "us-west-1"      => "drds.ap-northeast-1.aliyuncs.com",
        ],
        "internal" => [
        ]
    ];
