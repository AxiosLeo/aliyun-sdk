...
class Emr extends ProductAbstract
{
    ...
    protected $endpoints = [
        ...
        "public"   => [
            ...
            "ap-southeast-1" => "emr.ap-northeast-1.aliyuncs.com",
            ...
            "cn-beijing"     => "emr.cn-beijing.aliyuncs.com",
            "cn-chengdu"     => "emr.cn-chengdu.aliyuncs.com",
            "cn-hangzhou"    => "emr.cn-hangzhou.aliyuncs.com",
            ...
            "us-west-1"      => "emr.ap-northeast-1.aliyuncs.com",
        ],
        "internal" => [
        ]
    ];
