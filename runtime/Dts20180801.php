 ...
 * @method $this setEndpointInstanceType($endpointInstanceType)
 * @method string getEndpointInstanceType()
 * @method $this setEndpointInstanceId($endpointInstanceId)
 * @method string getEndpointInstanceId()
 * @method $this setEndpointIP($endpointIP)
 * @method string getEndpointIP()
 * @method $this setEndpointPort($endpointPort)
