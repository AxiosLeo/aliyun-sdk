...
namespace aliyun\sdk\services\Dts20180801;
 ...
 * Class V20180801
 *
 * @package aliyun\sdk\services\Dts20180801
 ...
 * @method DescribeEndpointSwitchStatus DescribeEndpointSwitchStatus()
 * @method CreateSubscriptionInstance CreateSubscriptionInstance()
 * @method ResetSynchronizationJob ResetSynchronizationJob()
 * @method DescribeMigrationJobDetail DescribeMigrationJobDetail()
 * @method SwitchSynchronizationEndpoint SwitchSynchronizationEndpoint()
 ...
 * @method $this setSynchronizationDirection($synchronizationDirection)
 ...
 * @method string getOwnerId()
 */
class DescribeEndpointSwitchStatus extends Request
{
 ...
 * @method string getOwnerId()
 */
class ResetSynchronizationJob extends Request
{
 ...
 * @method $this setSynchronizationDirection($synchronizationDirection)
 * @method string getSynchronizationDirection()
 * @method $this setEndpoint_Type($endpoint_Type)
 * @method string getEndpoint_Type()
 * @method $this setEndpoint_InstanceType($endpoint_InstanceType)
 * @method string getEndpoint_InstanceType()
 * @method $this setEndpoint_InstanceId($endpoint_InstanceId)
 * @method string getEndpoint_InstanceId()
 * @method $this setEndpoint_IP($endpoint_IP)
 * @method string getEndpoint_IP()
 * @method $this setEndpoint_Port($endpoint_Port)
 * @method string getEndpoint_Port()
 * @method $this setOwnerId($ownerId)
 * @method string getOwnerId()
 */
class SwitchSynchronizationEndpoint extends Request
{
