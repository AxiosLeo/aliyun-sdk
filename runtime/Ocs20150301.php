...
namespace aliyun\sdk\services\Ocs20150301;
 ...
 * Class V20150301
 *
 * @package aliyun\sdk\services\Ocs20150301
 * @method ModifyInstanceAttribute ModifyInstanceAttribute()
 * @method DescribeHistoryMonitorValues DescribeHistoryMonitorValues()
 * @method ModifyInstanceCapacity ModifyInstanceCapacity()
 * @method ModifyHotKeySwitchMode ModifyHotKeySwitchMode()
 * @method DeactivateInstance DeactivateInstance()
 * @method DescribeMonitorValues DescribeMonitorValues()
 * @method DescribeSecurityIps DescribeSecurityIps()
 * @method AddAuthenticIP AddAuthenticIP()
 * @method DescribeInstances DescribeInstances()
 * @method ReplaceAuthenticIP ReplaceAuthenticIP()
 * @method DeleteInstance DeleteInstance()
 * @method ModifySecurityIps ModifySecurityIps()
 * @method RemoveAuthenticIP RemoveAuthenticIP()
 * @method FlushInstance FlushInstance()
 * @method ModifyNetworkType ModifyNetworkType()
 * @method VerifyPassword VerifyPassword()
 * @method CreateInstance CreateInstance()
 * @method DescribeRegions DescribeRegions()
 * @method DescribeAuthenticIP DescribeAuthenticIP()
 * @method DescribeZones DescribeZones()
 * @method DescribeMonitorItems DescribeMonitorItems()
 * @method DataOperate DataOperate()
 * @method ActivateInstance ActivateInstance()
 */
class V20150301
{
}
 ...
 * @method $this setInstanceId($instanceId)
 * @method string getInstanceId()
 * @method $this setSwitchMode($switchMode)
 * @method string getSwitchMode()
 * @method $this setExpireTime($expireTime)
 * @method int getExpireTime()
 * @method $this setKeyNumber($keyNumber)
 * @method int getKeyNumber()
 */
 ...
 * @method $this setInstanceId($instanceId)
 * @method string getInstanceId()
 * @method $this setAuthenticIP($authenticIP)
 ...
 * @method $this setInstanceId($instanceId)
 * @method string getInstanceId()
 * @method $this setOldAuthenticIP($oldAuthenticIP)
 * @method string getOldAuthenticIP()
 * @method $this setNewAuthenticIP($newAuthenticIP)
